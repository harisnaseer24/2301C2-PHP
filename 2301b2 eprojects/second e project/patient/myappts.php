...
<head>
   ...
   .print-record {
    ...
    <div class="content container-fluid" >
        ...
        $query = "SELECT `id`, `parent_name`, `phone_number`, `parent_email`, `Child Name`, `date of birth`, `Vaccine`, `preferred_time`, `hospital`, `Status` FROM `vaccination_appointments` WHERE `patientid`= '$user_id'";
