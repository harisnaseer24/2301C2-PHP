...
<div class="content container-fluid" style="min-height: 70vh;">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="datatable table table-hover table-center mb-0">
                                    ...
                                    <tbody>
                                        <?php
                                        $sql = "SELECT * FROM `vaccines` where `stock` = 'Available' ";
                                        ...
                                        if ($result->num_rows > 0) {
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                echo '<tr>';
                                                echo '<td><a href="#">' . $row["vaccine_name"] . '</a></td>';
                                                echo "<td><img src='../hospital/" . $row['picture'] . "' alt='Vaccine Picture' style='width: 100px; height: 100px;'></td>";
